...
export default function PendingComplaints() {
  ...
  const fetchComplaints = async () => {
    try {
      const response = await workerComplaintsAPI.getPendingComplaints();
      ...
      <main style={styles.main}>
        <div style={styles.content}>
          <div style={styles.header}>
            ...
            <p style={styles.subtitle}>Complaints that require your attention</p>
          </div>
          ...
          {complaints.length > 0 ? (
                  ...
                  <div className="card" style={styles.complaintCard}>
                    ...
                    <div style={styles.complaintFooter}>
                      ...
                      {complaint.sla_deadline && (
                        <span style={{...styles.complaintInfo, color: 'var(--accent-warning)'}}>
            ...
            <div className="card" style={styles.emptyState}>
              ...
              <p style={styles.emptyText}>You don't have any pending complaints to work on.</p>
            </div>
          )}
        </div>
      </main>
