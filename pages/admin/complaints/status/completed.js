...
export default function CompletedComplaints() {
  ...
  const fetchComplaints = async () => {
    try {
      ...
      // Filter for completed/resolved statuses
      const completedStatuses = ['COMPLETED', 'RESOLVED'];
      allComplaints = allComplaints.filter(c => completedStatuses.includes(c.status));
  ...
  if (loading || loadingData) {
    return (
      <div style={styles.loadingContainer}>
        ...
        <p style={styles.loadingText}>Loading completed complaints...</p>
      </div>
    );
  }
  ...
  return (
    <>
      <Head>
        <title>Completed Complaints - Admin - CivicSaathi</title>
      </Head>
        ...
        <main style={styles.main}>
          <div style={styles.content}>
            <div style={styles.header}>
              <div>
                <h1 style={styles.title}>✅ Completed/Resolved Complaints</h1>
                <p style={styles.subtitle}>
                  {complaints.length} complaint{complaints.length !== 1 ? 's' : ''} successfully completed
                </p>
              </div>
                    ...
                    <div style={styles.complaintCard}>
                      ...
                      <div style={styles.cardDetails}>
                        ...
                        <div style={styles.detailItem}>
                          <span style={styles.detailIcon}>📅</span>
                          <span style={styles.detailText}>
                            Completed: {new Date(complaint.updated_at || complaint.created_at).toLocaleDateString()}
                          </span>
                        </div>
                      </div>
