...
export default function PendingComplaints() {
  ...
  const fetchComplaints = async () => {
    try {
      ...
      const pendingStatuses = ['SUBMITTED', 'PENDING', 'FILTERING', 'SORTING'];
      allComplaints = allComplaints.filter(c => pendingStatuses.includes(c.status));
  ...
  if (loading || loadingData) {
    return (
      <div style={styles.loadingContainer}>
        ...
        <p style={styles.loadingText}>Loading pending complaints...</p>
      </div>
    );
  }
  ...
  return (
    <>
      <Head>
        <title>Pending Complaints - Admin - CivicSaathi</title>
      </Head>
        ...
        <main style={styles.main}>
          <div style={styles.content}>
            <div style={styles.header}>
              <div>
                <h1 style={styles.title}>⏳ Pending Review Complaints</h1>
                <p style={styles.subtitle}>
                  {complaints.length} complaint{complaints.length !== 1 ? 's' : ''} awaiting review
                </p>
              </div>
            ...
            {complaints.length === 0 ? (
              <div style={styles.emptyState}>
                ...
                <p style={styles.emptyText}>There are no complaints pending review at the moment.</p>
              </div>
            ) : (
