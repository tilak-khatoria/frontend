...
export default function UpvotedComplaints() {
  ...
  const fetchUpvotedComplaints = async () => {
    try {
      const response = await complaintAPI.getUpvotedComplaints();
      ...
      <main style={styles.main}>
        <div style={styles.content}>
          ...
          <div style={styles.header}>
            <div>
              <h1 style={styles.title}>Upvoted Complaints</h1>
              <p style={styles.subtitle}>
                Complaints you have upvoted to show your support
              </p>
            </div>
            <Link href="/complaints/all">
              <button className="btn btn-secondary" style={styles.browseBtn}>
          ...
          {filteredComplaints.length === 0 ? (
            <div style={styles.emptyState}>
              ...
              <h3 style={styles.emptyTitle}>No upvoted complaints found</h3>
              <p style={styles.emptyText}>
                {filter === 'all'
                  ? "You haven't upvoted any complaints yet."
                  : `No ${filter} complaints in your upvoted list.`}
              </p>
              <Link href="/complaints/all">
                ...
                <Link key={complaint.id} href={`/complaints/${complaint.id}`} style={{ display: 'flex', textDecoration: 'none' }}>
                  <div className="card" style={styles.complaintCard}>
                    ...
                    <div style={styles.upvotes}>
                      ...
                      <span>{complaint.upvote_count} upvote{complaint.upvote_count !== 1 ? 's' : ''}</span>
                    </div>
                  </div>
                </Link>
              ))}
